...
namespace CsharpProject
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            team1.Addplayers(playernames);

            string Team1Name = " ";
            Team1Name = team1.Addteamname(Team1Name);

            string Team1shrtclr = " ";
            Team1shrtclr = team1.Addshirtclr(Team1shrtclr);

            Console.WriteLine("team player 1 names : " + playernames[1] + " :" + playernames[2] + " :" + playernames[3]);
            Console.WriteLine("your team name is :" + Team1Name);
            Console.WriteLine("your shirt clr is :" + Team1shrtclr);
        }
...
namespace CsharpProject
{
    internal class Teams
    {
        public void Addplayers(string[] names)
        {
            ...
            Console.Write("Enter Team 1 players name ");
        ...
        public string Addteamname(string teamname)
        {
        ...
        public string Addshirtclr(string shrtclr)
        {
            Console.WriteLine("Enter shirt clr : ");
            shrtclr = Console.ReadLine();
            return shrtclr;
            ...
            //Mobile mobile1 = new Mobile("Ipone", 2025, "simple 15");
            //Mobile mobile2 = new Mobile("Samsung", 2025, "not 8");

            //Console.WriteLine(mobile1.tittle + " was made by " + mobile1.name + " in " + mobile1.model);

            //mobile2.model = 2026;
            //Console.WriteLine(mobile2.tittle + " lounched in "+ mobile2.model);
